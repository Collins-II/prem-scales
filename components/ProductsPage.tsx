...
const CATEGORIES = ["All", "Retail", "Laboratory", "Industrial"] as const;
const SORT_OPTIONS = [
  "Default",
  "Price: Low to High",
  "Price: High to Low",
  ...
  return (
    <main className="w-full bg-neutral-50 min-h-screen">
      ...
      <section className="w-full bg-white border px-6 md:px-10 ">
        <div className="max-w-5xl mx-auto px-4 py-3 flex flex-col gap-3 sm:gap-4 md:flex-row md:items-center md:justify-between">
